...
<div id="myNav">
    ...
    <ul class="fix">
        ...
        <li>
            <a href="policies.php" class="hov">Policies & Procedures</a>
        </li>
        <li>
            <a href="user.php" class="active">Manage</a>
        </li>
        <li id="right">
...
<div><?php echo 'Here you can manage your users!!<ul>';
while ($row = $ret->fetchArray(SQLITE3_ASSOC)) {
    $fname = $row['firstname'];
    echo '<li>'.ucfirst($fname).'</li>';
}
echo '</ul>';
?></div>
<!--
